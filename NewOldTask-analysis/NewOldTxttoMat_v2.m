...
% Create output table
taskData=table(transpose(TTL_ID),transpose(TTLdescription),transpose(timestamp),'VariableNames',{'TTLvalue','TTL_ID','Timestamp'});
...
% Save file
cd(tempCASEd);
savefilename=[block,'_',num2str(vi),'_',patientID,'.mat'];
