function [] = EyeAnalysis_DataExtract_v1(excelLOC , mainLOC, ptID, saveLOC)
...
for vi = 1:length(allvars)
    ...
    [outTABLE] = fixANDcombineTables(leftEYE_Learn,rightEYE_Learn,leftEYE_Recog,...
        rightEYE_Recog , picT_L, picT_R, learnTTLsummary, recogTTLsummary, recogINFO);
