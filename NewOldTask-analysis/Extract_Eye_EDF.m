function [] = Extract_Eye_EDF(excelLOC , mainLOC, ptID, basePath)
...
for vi = 1:length(allvars)
    ...
    [ltmpName] = Edf2Mat_UCH(basePath, learnEDF{1}, outFOLDS{ptIdx}, 'Learn',...
    ...
    [rtmpName] = Edf2Mat_UCH(basePath, recogEDF{1}, outFOLDS{ptIdx}, 'Recog',...
        varianT, tempCASEd, tempCASEd);
