...
% edf0 = Edf2Mat('C:\Users\darwinm\Documents\Github\edf-converter-master\eyedata.edf');
...
%plot(testEDF.Samples.posX(end - 2000:end), testEDF.Samples.posY(end - 2000:end), 'o');
...
%edf1 = Edf2Mat('C:\Users\darwinm\Documents\Github\edf-converter-master\eyedata.edf');
...
%% Plot the progress of the pupil size - ERROR
%Index in position 2 is invalid. Array indices must be positive integers or logical values.
figure();
plot(edf0.Samples.pa(end - 500:end, 2));
%plot(edf1.Samples.pa(end-500:end));
